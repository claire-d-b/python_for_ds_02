...
def load(path: str) -> DataFrame:
    ...
    try:
        ...
        assert not read_csv('src/life_expectancy_years.csv', encoding='utf-8-sig').empty, "Unable to open file"

        frame = read_csv('src/life_expectancy_years.csv', encoding='utf-8-sig')
